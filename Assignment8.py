...
# recurrence of the form T(n) = aT(n/b) + O(nc).
...
# [5] Create additional functions f2 thru f10 corresponding to nine more recurrences from the slides or old exams.
...
def prepare_output(data, n, ranked=False):
    ...
    heads = ["Name", "Description", "Recurrence", "Parameters",
             "Function Syntax", "Master Theorem", "Value", "Log Value"]
...
#
# the name of the function (e.g. f1)
# the recurrence
# the extracted parameters
# the classification made by master theorem
# the final and intermediate values calculated.

# [9] Repurpose the table and chart from the previous two assignments to list and plot the values.
