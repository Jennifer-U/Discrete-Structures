...
def random_list(n):
    numbers = [0] * n  # making list of n numbers each with value 0
    numbers[0] = randint(1, 10)  # inclusive
    for i in range(1, n):
...
def ternary_search_recursive_rec(arr, key, l, r):  # breaks into 3 parts
    if r >= l:
        mid1 = l + (r - l) // 3
        mid2 = r - (r - l) // 3
        if arr[mid1] == key:
...
def binary_search_randomized_rec(arr, key, l, r):
    if r >= l:
        mid = randint(l, r)  # picks random position in left and right
        if arr[mid] == key:
            return mid
        elif arr[mid] > key:
...
def ternary_search_randomized_rec(arr, key, l, r):
    if r >= l:
        ...
        if arr[mid1] == key:
            ...
            return ternary_search_randomized_rec(arr, key, mid1 + 1, mid2 - 1)  # middle part
    return -1
...
# See https://www.geeksforgeeks.org/matplotlib-tutorial/
...
def run_algs(algs, sizes, trials):  # can use for search algorithms and to test various algorithms,
    dict_algs = {}
    for alg in algs:
...
def main():
    ...
    searches = [native_search, linear_search, linear_search_sentinel,
                binary_search_iterative, binary_search_recursive, binary_search_randomized,
                binary_search_onesided, binary_search_better, ternary_search_iterative,
                ternary_search_recursive, ternary_search_randomized, exponential_search, jump_search,
    ...
    # arr = random_list(100)
    # key = arr[randint(0, len(arr) - 1)]
    # print(native_search(arr, key))
    # print(linear_search(arr, key))
    # print(binary_search_iterative(arr, key))
    # print(binary_search_recursive(arr, key))
    # print(ternary_search_recursive(arr, key))
    # print(randomized_binary_search(arr, key))
    # print(randomized_ternary_search(arr, key))
